        ...
        <div class="banner_area inner_banner">
            ...
            <div class="container">
                <div class="banner_left parallax-fast parallax-content">
                    ...
                    <a href="{{ route('contact') }}" class="button white_btn mt_40">
                ...
                <div class="contact_box mt_100 fade-up">
                    ...
                    <form id="contactForm" class="contact_form">
                        ...
                        <div class="row medium-gap">
                            ...
                            <div class="col-sm-6 mt_25">
                                <input type="tel" name="phone" class="phone" placeholder="Enter your mobile number" required>
                            </div>                            
                            <div class="col-sm-6 mt_25">
                                <input type="text" name="subject" class="subject" placeholder="Enter your subject" required>
                            </div>
