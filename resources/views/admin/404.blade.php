        ...
        <main class="error-page">
            <div class="container">
                ...
                <div class="error-page__heading">
                    <h1 class="error-page__heading-title">The page has not been created yet</h1>
                    <p class="error-page__heading-desciption">Contact Your Developer</p>
                    <h1 class="error-page__heading-title">OR</h1>
                </div>
            
                <a class="error-page__button" href="{{ route('dashboard') }}" aria-label="back to home" title="back to home">Dashboard</a>
            </div>
        </div>
