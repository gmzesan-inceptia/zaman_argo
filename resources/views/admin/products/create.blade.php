                        ...
                        <div class="card-body custom-form">
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea name="description" rows="4" class="form-control custom-input" placeholder="Write product details...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="error_msg">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="col-12 mb-3">
                            <div class="card table-card">
                                ...
                                <div class="custom-form card-body">
                                    <div class="image-select-file">
                                        <label class="form-label custom-label" for="product_image">
                                            ...
                                            <div class="user-image">
                                                <img id="product_imagePreview" src="{{ asset('images/default.jpg') }}"
                                                    class="image-preview">
                                    ...
                                    {{-- Remove button --}}
                                    <div class="delete-btn mt-2 d-none remove-image" id="product_imageDelete"
                            ...
                            <div class="gallery-upload-wrapper">
                                ...
                                <label for="product_images" class="gallery-upload-label">
                                    <div class="gallery-upload-box">
                                        ...
                                        <h5 class="mb-2">Click to upload gallery images</h5>
